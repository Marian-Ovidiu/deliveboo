    ...
    public function run(Faker $faker) {
        ...
        $data = [
            ...
            [
                ...
                'opening_time' => $faker->time,
                'closing_time' => $faker->time,
                'logo' => 'https://bit.ly/3dG5oFK',
                'telephone' => $faker->numerify('##########'),
                'email' => $faker->unique()->safeEmail(),
                'website' => $faker->url(),
            ],
            [
                'name' => 'Boolean Proj25 - Team#5',
                'description' => 'Negozio di prelibatezze alimentari',
                'address' => $faker->address(),
                'closing_day' => $faker->randomElement($closingDays),
                'opening_time' => $faker->time,
                'closing_time' => $faker->time,
                'logo' => 'https://bit.ly/3xeSrdv',
                'telephone' => $faker->numerify('##########'),
                'email' => $faker->unique()->safeEmail(),
                'website' => $faker->url(),
            ],
