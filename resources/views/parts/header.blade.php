<div class="header-restaurant">
    <div class="header-restaurant-row">
        <div class="col-12 header-restaurant-row-jumbotronn" style="background-image: url('https://wallpaperaccess.com/full/1306153.jpg')">
            <div class="header-restaurant-row-jumbotronn-cover row">
                ...
                <div class="col-5 header-restaurant-row-jumbotronn-cover-logo">
                    ...
                    <div class="header-restaurant-row-jumbotronn-cover-logo-box fl">
                        <div class="header-restaurant-row-jumbotronn-cover-logo-box-title">Kfc – Kentucky</div>
                        <div class="header-restaurant-row-jumbotronn-cover-logo-box-types">Hot Dogs, Pizza & Stakes</div>
                    </div>
                </div>
